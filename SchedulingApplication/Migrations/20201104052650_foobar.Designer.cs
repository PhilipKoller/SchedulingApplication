...
namespace SchedulingApplication.Migrations
{
    ...
    [Migration("20201104052650_foobar")]
            ...
            modelBuilder.Entity("SchedulingApplication.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Color = "Purple",
                            EndTime = new DateTime(2020, 11, 3, 21, 26, 50, 609, DateTimeKind.Local).AddTicks(8445),
                            EventType = 0,
                            Location = 53,
                            NumOfPeople = 95,
                            PocPhoneNumber = "972-523-4343",
                            PocRankName = "phil",
                            StartTime = new DateTime(2020, 11, 3, 21, 26, 50, 608, DateTimeKind.Local).AddTicks(507)
                        });
                });
